...
from ownbot.config.paths import get_media_dir
from ownbot.config.schema import TelegramConfig
...
class TelegramChannel(BaseChannel):
    ...
    async def _send_with_streaming(
        ...
        try:
            ...
            # Draft message is optional; fall back to regular send on any error
            pass
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm OwnBot.\n\n"
    ...
    async def _on_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        logger.debug(
            "Telegram message from SenderId:{} (ChatId {}): {}...", sender_id, chat_id, content[:50]
        )
